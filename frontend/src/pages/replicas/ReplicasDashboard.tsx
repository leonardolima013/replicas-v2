    ...
    <div className="p-8">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-card shadow-soft p-8 border border-gray-200 dark:border-gray-800 text-center py-16">
            ...
            <div className="flex justify-center mb-6">
              <div className="bg-gray-100 dark:bg-gray-800 rounded-full p-8">
                <Database className="w-24 h-24 text-gray-300 dark:text-gray-600" />
              </div>
            </div>
            ...
            {/* Mensagem de erro */}
            {error && (
              <div className="bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-button p-4 mb-6 max-w-md mx-auto flex items-start gap-3">
      ...
      {replica && !creating && (
        <div className="max-w-4xl mx-auto space-y-6">
          ...
          <div className="bg-white dark:bg-gray-900 rounded-card shadow-soft p-8 border border-gray-200 dark:border-gray-800">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              {/* Host */}
              <div className="bg-gray-50 dark:bg-gray-800 rounded-button p-4">
              ...
              {/* Porta */}
              <div className="bg-primary-50 dark:bg-primary-900/20 border-2 border-primary-200 dark:border-primary-800 rounded-button p-4">
                <label className="text-xs font-medium text-primary-700 dark:text-primary-300 uppercase tracking-wider block mb-2">
                  Porta (Importante!)
                </label>
                <div className="flex items-center justify-between">
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-800">
              ...
              <div className="bg-gray-900 dark:bg-black rounded-button p-4 flex items-center justify-between">
                <code className="text-sm font-mono text-green-400 dark:text-green-300 flex-1">
                  {getSSHCommand()}
                </code>
                <button
            ...
            <div className="mt-6 pt-6 border-t border-gray-200 dark:border-gray-800">
              <button
                ...
                disabled={deleting}
                className="btn-secondary text-red-600 dark:text-red-400 border-red-300 dark:border-red-800 hover:bg-red-50 dark:hover:bg-red-900/20 hover:border-red-400 dark:hover:border-red-700 w-full disabled:opacity-50 disabled:cursor-not-allowed"
              >
                {deleting ? (
                  <>
