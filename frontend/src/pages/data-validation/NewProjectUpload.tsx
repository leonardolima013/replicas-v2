...
export default function NewProjectUpload() {
  ...
  return (
    <div className="p-8">
      ...
      {/* Mensagem de Erro */}
      {error && (
        <div className="mb-6 bg-red-50 dark:bg-red-900/20 border border-red-200 dark:border-red-800 rounded-card p-4 flex items-start gap-3">
      ...
      <div className="bg-white dark:bg-gray-900 rounded-card shadow-soft p-8 border border-gray-200 dark:border-gray-800 space-y-6">
        {/* Nome do Projeto */}
        <div>
          <label
            htmlFor="projectName"
        ...
        <div>
          ...
          >
            ...
            {!selectedFile ? (
              ...
              <>
                <FileCheck className="w-12 h-12 text-green-500 dark:text-green-400 mx-auto mb-4" />
                <p className="text-base font-medium text-gray-900 dark:text-white mb-1">
                  {selectedFile.name}
                </p>
                <p className="text-sm text-gray-500 dark:text-gray-400">
